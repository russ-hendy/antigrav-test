...
If you want to get it to run, clone it, add OPEN_AI_API_KEY to an .env file on the root withh your own key [BEWARE THIS IS EXPOSED CLIENT SIDE FOR NOW. IN PRODUCTION MOVE IT SERVER-SIDE!!]], run yarn, and then yarn dev. 
